...
output "AWSIoT1ClickReadOnlyAccess" {
  value       = "arn:aws:iam::aws:policy/AWSIoT1ClickReadOnlyAccess"
  description = "https://console.aws.amazon.com/iam/home?#/policies/arn:aws:iam::aws:policy/AWSIoT1ClickReadOnlyAccess"
}
